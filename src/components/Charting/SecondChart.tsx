...
interface SecondChartProps {
    patientEmail: string | undefined; // Or string if always defined
  }
  
  


  const SecondChart: React.FC<SecondChartProps> = ({ patientEmail,    }) => {
    ...
    const { data, loading, error } = useQuery(CHECK_2d_CHART_ID, {
        variables: { email: patientEmail }, // Add variables for the query if needed
        skip: !patientEmail, // Skip query if patientEmail is not provided
      });
  ...
  return (
    <View style={styles.container}>
     ...
     <View style={styles.Pickercontainer}>
      <Text style={styles.label}>Your Chart</Text>
