...
const ToothChart: React.FC = () => {
    const [selectedColor, setSelectedColor] = useState<string>('blue'); // Default color is blue
    ...
    const handleClick = (toothId: string): void => {
      console.log(`Tooth clicked: ${toothId}`);
      setToothColors((prevColors) => ({
        ...prevColors,
        [toothId]: selectedColor, // Change color of clicked tooth
      }));
    };
  
    const getToothColor = (toothId: string): string => {
      return toothColors[toothId] || '#FFFFFF'; // Default to white if not yet colored
    };
     ...
     <View style={styles.Pickercontainer}>
      ...
      {/* {selectedColor && (
        <View style={[styles.selectedColor, { backgroundColor:selectedColor,
         borderWidth:1,padding:20,borderRadius:99}]}>
      ...
      {/* SVG Tooth Chart */}
      <Svg width={width - 50} height={height} viewBox="100 2 245 900"  preserveAspectRatio="xMidYMid meet"  style={{alignSelf:"center",borderWidth:1}}>
    
            <G id="toothLabels">
              <text id="lbl48" transform="matrix(1 0 0 1 97.9767 402.1409)">
                48
              </text>
              <text id="lbl47" transform="matrix(1 0 0 1 94.7426 449.1693)">
                47
              </text>
              <text id="lbl46" transform="matrix(1 0 0 1 106.0002 495.5433)">
                46
              </text>
              <text id="lbl45" transform="matrix(1 0 0 1 118.0002 538.667)">
                45
              </text>
              ...
              <text id="lbl43" transform="matrix(1 0 0 1 157.3335 603.8164)">
                43
              </text>
              <text id="lbl42" transform="matrix(1 0 0 1 179.3335 623.8164)">
                42
              </text>
              <text id="lbl41" transform="matrix(1 0 0 1 204.6669 628.483)">
                41
              </text>
              <text id="lbl31" transform="matrix(1 0 0 1 231.3335 628.1497)">
                31
              </text>
              <text id="lbl32" transform="matrix(1 0 0 1 256.3335 619.1497)">
                32
              </text>
              <text id="lbl33" transform="matrix(1 0 0 1 276.3335 602.483)">
                33
              </text>
              <text id="lbl34" transform="matrix(1 0 0 1 286.6669 573.1497)">
                34
              </text>
              <text
                id="lbl 35"
                transform="matrix(1 0 0 1 303.6327 538.667)"
                ffont-family={"../../../assets/fonts/Avenir Heavy.ttf"}
              >
                35
              </text>
              <text id="lbl36" transform="matrix(1 0 0 1 322.983 495.5432)">
                36
              </text>
              <text id="lbl37" transform="matrix(1 0 0 1 325.1251 449.1686)">
                37
              </text>
              <text id="lbl38" transform="matrix(1 0 0 1 324.0004 402.1405)">
                38
              </text>
              <text id="lbl28" transform="matrix(1 0 0 1 312.8534 324.1021)">
                28
              </text>
              <text id="lbl27" transform="matrix(1 0 0 1 315.3335 275.3333)">
                27
              </text>
              <text id="lbl26" transform="matrix(1 0 0 1 311.3335 236)">
                26
              </text>
              <text id="lbl25" transform="matrix(1 0 0 1 300.3335 200.6667)">
                25
              </text>
              <text id="lbl24" transform="matrix(1 0 0 1 286.6669 172)">
                24
              </text>
              <text id="lbl23" transform="matrix(1 0 0 1 270.2269 142.439)">
                23
              </text>
              <text id="lbl22" transform="matrix(1 0 0 1 247.5099 118.9722)">
                22
              </text>
              <text id="lbl21" transform="matrix(1 0 0 1 227.8432 112.9722)">
                21
              </text>
              <text id="lbl11" transform="matrix(1 0 0 1 200.1766 112.9722)">
                11
              </text>
              <text id="lbl12" transform="matrix(1 0 0 1 170.5099 117.6388)">
                12
              </text>
              <text id="lbl13" transform="matrix(1 0 0 1 148.6667 134.167)">
                13
              </text>
              <text id="lbl4" transform="matrix(1 0 0 1 131.3605 164.8335)">
                14
              </text>
              <text id="lbl5" transform="matrix(1 0 0 1 119.3927 195.6387)">
                15
              </text>
              <text id="lbl6" transform="matrix(1 0 0 1 103.8631 234.4391)">
                16
              </text>
              <text id="lbl7" transform="matrix(1 0 0 1 96.2504 275.9999)">
                17
              </text>
              <text id="lbl18" transform="matrix(1 0 0 1 93.9767 324.769)">
                18
              </text>
            </G>
        ...
        onClick={() => handleClick("Tooth48")}
                
              />
              <polygon
                id="Tooth47"
                fill={getToothColor('Tooth47')} 
                data-key="47"
        ...
        46.7,476.7 37.7,446.3 39.7,438.3 43.3,432 49,426.7 56,424.7 65,424.7 	"
                onClick={() => handleClick("Tooth47")}
              />
              <polygon
                id="Tooth46"
                fill={getToothColor('Tooth46')} 
                data-key="46"
        ...
        60.3,529.7 56.3,523.7 51.7,511 47.7,494.7 47.7,488.3 50.3,483.3 55,479.7 67,476.7 	"
                onClick={() => handleClick("Tooth46")}
              />
              <polygon
                id="Tooth45"
                fill={getToothColor('Tooth45')} 
                data-key="45"
        ...
        98.3,578.3 88,579 82,575 75,565 69.3,552.3 67.3,542 69.7,536 74.3,531.7 84.3,528.3 	"
                onClick={() => handleClick("Tooth45")}
              />
              <path
                id="Tooth44"
                fill={getToothColor('Tooth44')} 
                data-key="44"
        ...
        l-7.3-7l-5-9l-2-10c0,0-0.7-7,0.3-7.3c1-0.3,5.3-6.7,5.3-6.7l9-5H117.3z"
                onClick={() => handleClick("Tooth44")}
              />
              <polygon
                id="Tooth43"
                fill={getToothColor('Tooth43')} 
                data-key="43"
        ...
        133.3,641.3 128.7,634.7 128.7,629 132.7,621.3 137.7,615 143.7,611 149.7,610 	"
                onClick={() => handleClick("Tooth43")}
              />
              <polygon
                id="Tooth42"
                fill={getToothColor('Tooth42')} 
                data-key="42"
        ...
        168,656.3 159.3,649.7 156.7,644 162,639.3 	"
                onClick={() => handleClick("Tooth42")}
              />
              <polygon
                id="Tooth41"
                fill={getToothColor('Tooth41')} 
                data-key="41"
        ...
        190.3,662.7 193,657.3 199.7,647.3 207,638 210.7,635.5 	"
                onClick={() => handleClick("Tooth41")}
              />
              <path
                id="Tooth31"
                fill={getToothColor('Tooth31')} 
                data-key="31"
        ...
        321,630 321.3,620.3 317,614.3 308,608 298.3,607 291,609.3 287,612.3 286.7,617.7 287.3,624.7 	"
                onClick={() => handleClick("Tooth33")}
              />
              <polygon
                id="Tooth34"
                fill={getToothColor('Tooth34')} 
                data-key="34"
        ...
        342.7,604 337.7,609 328,612.7 320,613.3 315,611 308.3,604.7 306.7,598 307.3,591.3 309,584.7 312.7,578.3 318.3,571.7 	"
                onClick={() => handleClick("Tooth34")}
              />
              <polygon
                id="Tooth35"
                fill={getToothColor('Tooth35')} 
                data-key="35"
        ...
        381.3,524.3 374,520.7 363.7,516.3 356.3,515.3 351.3,518.3 346.3,524 340.3,534.3 336,546.7 	"
                onClick={() => handleClick("Tooth35")}
              />
              <path
                id="Tooth36"
                fill={getToothColor('Tooth36')} 
                data-key="36"
        ...
        c-0.3-1.3-0.3-11-0.3-11l3.7-14.3l3.7-7l5.3-6.7l8-2l9.7-0.7L398,470z"
                onClick={() => handleClick("Tooth36")}
              />
              <polygon
                id="Tooth37"
                fill={getToothColor('Tooth37')} 
                data-key="37"
        ...
        407.7,427.3 	"
                onClick={() => handleClick("Tooth37")}
              />

              <polygon
                id="Tooth38"
                fill={getToothColor('Tooth38')} 
                data-key="38"
        ...
        406.7,395 401,377.7 397.3,373 390.7,367.3 380,365 373,366.7 367.3,369 364,374.3 360,389 363.3,401.3 367.7,412.3 	"
                onClick={() => handleClick("Tooth38")}
              />
              <polygon
                id="Tooth28"
                fill={getToothColor('Tooth28')} 
                data-key="27"
      ...
      <View>
      <PrimaryButton title="Saved" onPress={() => alert('Created Successfully!')} />
      </View>
    </View>
  );
};
